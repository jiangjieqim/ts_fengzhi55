...
import { StarShopBuy_req } from "../../../../network/protocols/BaseProto";
...
export class XXZDZShopGMView extends ViewBase{
    private _ui:ui.views.xxzdz.ui_xxzdzGMViewUI;
    ...
    private onBtnQDClick(){
        if(this._data){
            let req:StarShopBuy_req = new StarShopBuy_req;
