...
/**坐骑翻牌 */
export class LingChongFanPaiView extends ViewBase{
    private _ui:ui.views.lingchong.ui_lingchongFPViewUI;
    ...
    private onPlayEnd() {
        if (LingChongModel.Ins._bo) {
            Laya.timer.once(500,this,()=>{
                if (!LingChongModel.Ins.isBagMax(3)) {
                    LingChongModel.Ins.getPetAction(LingChongModel.Ins._sel,2,LingChongModel.Ins._bo);
                }else{
                    this._ui.sp.visible = false;
                    this._ui.tf1.visible = true;
