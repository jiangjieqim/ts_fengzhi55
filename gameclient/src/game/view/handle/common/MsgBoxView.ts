...
// import { EViewType, EMsgBoxType, EPageType } from "../../../common/defines/EnumDefine";
...
//     private _clearCall: Callback;       // 弹窗关闭时的回调
...
//     }
//     protected onExit() {
//         if (this._clearCall) this._clearCall.Invoke();
...
//     public ShowMsgBox(type: EMsgBoxType, content: string, sureCall: Callback, cancelCall: Callback) {
