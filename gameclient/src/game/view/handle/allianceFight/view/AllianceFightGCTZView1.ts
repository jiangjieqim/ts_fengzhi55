...
import { AllianceWarCityDetail_req, AllianceWarCityFresh_req, stAllianceWarCityContent } from "../../../../network/protocols/BaseProto";
...
export class AllianceFightGCTZView1 extends ViewBase{
    private _ui:ui.views.allianceFight.ui_allianceFightGCTZView1UI;
    ...
    private _ctl4:AllianceFightGCTZCtl;
    private _ctl5:AllianceFightGCTZCtl;
