...
import { BuyMilitaryPledge_req } from "../../../../network/protocols/BaseProto";
import { ItemViewFactory } from "../../main/model/ItemViewFactory";
import { MainModel } from "../../main/model/MainModel";
import { ECellType } from "../../main/vos/ECellType";
import { ItemVo } from "../../main/vos/ItemVo";
import { IconUtils } from "../../zuoqi/vos/IconUtils";
import { FuJiangConfigProxy } from "../proxy/FuJiangProxy";

export class FuJiangGMView extends ViewBase{
    private _ui:ui.views.fujiang.ui_fujiangGMViewUI;
    ...
    private onBtnQDClick(){
        if(this._data){
            let req:BuyMilitaryPledge_req = new BuyMilitaryPledge_req;
            req.num = this._num;
